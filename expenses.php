...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $dateValid = $dateIncurred !== '' && strtotime($dateIncurred) !== false;
...
try {
    $stmt = $pdo->query(
        'SELECT Date_Incurred, Payee, Category, Amount
         FROM Expenses
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <?php if (empty($records)): ?>
                                <tr>
                                    <td colspan="4" class="px-6 py-8 text-center text-slate-500">No expense records yet.</td>
                                </tr>
                            <?php else: ?>
